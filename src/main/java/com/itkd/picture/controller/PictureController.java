...
public class PictureController {
     ...
     * @param request             HTTP请求对象，用于获取查询字符串参数
    ...
    public BaseResponse<Page<PictureVO>> listPictureVOByPageWithCache(@RequestBody PictureQueryRequest pictureQueryRequest,
        ...
        String cacheKey = "kdcPicture:listPictureVOByPage:" + hashKey;
        /**
         * 先在本地缓存中查找，如果存在则直接返回，否则再从 Redis 中查找，在 Redis 中没有找到再从数据库中查询，并将结果缓存到 Redis 中。
         */
        // 1. 查询本地缓存（Caffeine）
